 ...
 * mobile. The section is pinned for an extra scroll range while the
 * mockup zooms from the full screen into the top card, then pans down
 * into the "Recently Vaulted" list — a single continuous zoom on one
 * static image, not a swap between crops.
 */
...
export function Hero() {
  ...
  // Hold → zoom into the top card → hold → pan down into the list → hold.
          ...
          <div className="container-1140 grid w-full grid-cols-1 items-center gap-16 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)] max-[768px]:gap-2">
            ...
            <Reveal className="order-1 lg:order-2">
              <div className="flex justify-center">
                <div className="relative h-[532px] w-[260px] overflow-hidden drop-shadow-[0_30px_50px_rgba(0,0,0,0.18)] max-[1024px]:h-[221px] max-[1024px]:w-[108px]">
